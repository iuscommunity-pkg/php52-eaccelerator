...
%define name php52-eaccelerator
...
Requires: php52-common = %{php_version}
Requires: tmpwatch

Provides: %{real_name} = %{version}-%{release}

Conflicts:php52-mmcache
BuildRequires: php52-devel
...
%changelog
* Wed Apr 25 2012 Jeffrey Ness <jeffrey.ness@rackspace.com> - 0.9.6.1-8.ius
- Removing ghost lines and following EPEL on file attrs,
  resolves LP#987816

* Wed Feb 01 2012 Jeffrey Ness <jeffrey.ness@rackspace.com> - 0.9.6.1-7.ius
- Rebuilding against latest PHP

* Tue Oct 18 2011 Jeffrey Ness <jeffrey.ness@rackspace.com> - 0.9.6.1-6.ius
- Requires tmpwatch due to cronjob

* Wed Oct 12 2011 Jeffrey Ness <jeffrey.ness@rackspace.com> - 0.9.6.1-5.ius
...
* Sun Jan 07 2011 Jeffrey Ness <jeffrey.ness@rackspace.com> - 0.9.6.1-3.ius
- Porting from Fedora to IUS
- Require autoconf < 2.63
- Removed Provides: php-zend_extension
- Removed Epoch
